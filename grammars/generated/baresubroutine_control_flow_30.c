...
void func_5643483888();
void func_5643484736();
void func_5643484864();
void func_5643484016();
void func_5643479696();
void func_5643484672();
void func_5643480064();
...
void __attribute__((noinline)) func_5643476720() {
    ...
    switch (branch) {
        case 0:
            CALL(func_5643484736);
            break;
        case 1:
            CALL(func_5643484016);
            break;
        case 2:
...
void __attribute__((noinline)) func_5643483888() {
    asm goto (
        "cmp x1, #30\n\t"
        "bgt %l[depth_exceeded]\n\t"
        :
...
void __attribute__((noinline)) func_5643484736() {
    asm goto (
        "cmp x1, #30\n\t"
        "bgt %l[depth_exceeded]\n\t"
        :
...
void __attribute__((noinline)) func_5643484864() {
    asm goto (
        "cmp x1, #30\n\t"
        "bgt %l[depth_exceeded]\n\t"
        :
...
void __attribute__((noinline)) func_5643484016() {
    asm goto (
        "cmp x1, #30\n\t"
        "bgt %l[depth_exceeded]\n\t"
        :
...
void __attribute__((noinline)) func_5643479696() {
    asm goto (
        "cmp x1, #30\n\t"
        "bgt %l[depth_exceeded]\n\t"
        :
...
void __attribute__((noinline)) func_5643484672() {
    asm goto (
        "cmp x1, #30\n\t"
        "bgt %l[depth_exceeded]\n\t"
        :
...
void __attribute__((noinline)) func_5643480064() {
    asm goto (
        "cmp x1, #30\n\t"
        "bgt %l[depth_exceeded]\n\t"
        :
